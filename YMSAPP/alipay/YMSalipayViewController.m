...
#import "YMSalipayViewController.h"
#import "PartnerConfig.h"
#import "DataSigner.h"
#import "AlixPayResult.h"
#import "DataVerifier.h"
#import "YMSAppDelegate.h"
@interface YMSalipayViewController ()

@end

@implementation YMSalipayViewController
...
- (void)viewDidLoad
{
    ...
    self.name.text = @"有美食订单";
    self.info.text = @"菜品订单内容";
    YMSAppDelegate * myAppDelegate = (YMSAppDelegate *)[[UIApplication sharedApplication] delegate];
    self.price.text = myAppDelegate.strTotalPrice;
