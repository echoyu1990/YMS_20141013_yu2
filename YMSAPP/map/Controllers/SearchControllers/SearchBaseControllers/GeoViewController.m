...
//    
//    
//    NSNumber * floatNumberLatitude = [NSNumber numberWithFloat:geocode.location.latitude ];
//    
//    
//      NSNumber * floatNumberLongitude = [NSNumber numberWithFloat:geocode.location.longitude ];
//    
...
//    [[NSUserDefaults standardUserDefaults] synchronize];
    ...
    if (geocode != nil)
    {
//        [self.delegate passValue:geocode.location];
//        [self.delegate passAdress:geocode.formattedAddress];
        //退回到第一个窗口
...
- (MAAnnotationView *)mapView:(MAMapView *)mapView viewForAnnotation:(id<MAAnnotation>)annotation
{
    if ([annotation isKindOfClass:[GeocodeAnnotation class]])
    {
        ...
        AMapGeocode *geocode = [(GeocodeAnnotation*)annotation geocode];
        [self.delegate passValue:geocode.location];
        [self.delegate passAdress:geocode.formattedAddress];
        ...
        [myUserDefaults setObject:geocode.city forKey:@"city"];
        
        [myUserDefaults setObject:geocode.district forKey:@"district"];
...
- (void)onGeocodeSearchDone:(AMapGeocodeSearchRequest *)request response:(AMapGeocodeSearchResponse *)response
{
    ...
    //地图标记放大显示
    CLLocationCoordinate2D centerCoordinate = CLLocationCoordinate2DMake(((GeocodeAnnotation *)(annotations[0])).geocode.location.latitude, ((GeocodeAnnotation *)(annotations[0])).geocode.location.longitude);
    
    MACoordinateRegion viewRegion = MACoordinateRegionMakeWithDistance(centerCoordinate, 10000, 10000);
